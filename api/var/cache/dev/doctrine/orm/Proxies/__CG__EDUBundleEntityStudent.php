 ...
 */
class Student extends \EDUBundle\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EDUBundle\\Entity\\Student' . "\0" . 'users', '' . "\0" . 'EDUBundle\\Entity\\Student' . "\0" . 'id', '' . "\0" . 'EDUBundle\\Entity\\Student' . "\0" . 'classes'];
        }
