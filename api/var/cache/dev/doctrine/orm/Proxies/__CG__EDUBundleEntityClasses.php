 ...
 */
class Classes extends \EDUBundle\Entity\Classes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EDUBundle\\Entity\\Classes' . "\0" . 'subjects', '' . "\0" . 'EDUBundle\\Entity\\Classes' . "\0" . 'id', '' . "\0" . 'EDUBundle\\Entity\\Classes' . "\0" . 'className'];
        }
