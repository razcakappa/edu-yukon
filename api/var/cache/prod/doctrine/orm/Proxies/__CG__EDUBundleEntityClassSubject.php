 ...
 */
class ClassSubject extends \EDUBundle\Entity\ClassSubject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EDUBundle\\Entity\\ClassSubject' . "\0" . 'id', '' . "\0" . 'EDUBundle\\Entity\\ClassSubject' . "\0" . 'class', '' . "\0" . 'EDUBundle\\Entity\\ClassSubject' . "\0" . 'subjects'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassSubject $proxy) {
