 ...
 */
class contact extends \EDUBundle\Entity\contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EDUBundle\\Entity\\contact' . "\0" . 'userId', '' . "\0" . 'EDUBundle\\Entity\\contact' . "\0" . 'address', '' . "\0" . 'EDUBundle\\Entity\\contact' . "\0" . 'postCode', '' . "\0" . 'EDUBundle\\Entity\\contact' . "\0" . 'contactNumber'];
        }
