 ...
 */
class Teacher extends \EDUBundle\Entity\Teacher implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EDUBundle\\Entity\\Teacher' . "\0" . 'id', '' . "\0" . 'EDUBundle\\Entity\\Teacher' . "\0" . 'users', '' . "\0" . 'EDUBundle\\Entity\\Teacher' . "\0" . 'classes'];
        }
